...
@Component({
  ...
  templateUrl: './statesmonitor.component.html',
  styleUrls: ['./statesmonitor.component.css']
})
export class StatesmonitorComponent implements OnInit {
  ...
  constructor(private httpService: ApiService, private echartService: EqpinfoChartOptionService,
    private echartCommonService:EchartService) {
